...
class IndexController extends Zend_Controller_Action  {
   ...
   public function createAction() {
    ...
    function selectchainAction() {
    	...
    	switch ($select_type) { 		
			case 'clan_ssigas': 
				# get all the ssigas in a clan
				$field = $this->_getParam('fieldid');	
				if(isEmptyString($field)){
					$field = 'clanid';	
				}
				echo generateJSONStringForSelectChain(getSsigasInClan($this->_getParam($field)), $this->_getParam('currentvalue'));			
				break;
			case 'ssaza_places': 
				# get all places in a ssaza
				$field = $this->_getParam('fieldid');
				echo generateJSONStringForSelectChain(getPlacesInSsaza($this->_getParam($field)), $this->_getParam('currentvalue'));			
				break;
			default: 
