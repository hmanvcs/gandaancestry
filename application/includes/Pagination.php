...
class Pagination {
	...
	protected $_itemcountperpage = 50;
	
	protected $_itemcount; 
	/**
	 * 
	 * Alias for the filter tables 
	 * @var String 
	 */
	protected $_filtertablealias = ""; 	
	protected $_hasusertypefilter = "N"; 
	 ...
	 */
	public function getFilterTableAlias() {
		return $this->_filtertablealias;
	}

	/**
	 * @param String $_filtertablealias
	 */
	public function setFilterTableAlias($filtertablealias) {
		$this->_filtertablealias = $filtertablealias;
	}
	/**
	 * @return the $_hasusertypefilter
	 */
	public function getHasUserTypeFilter() {
		return $this->_hasusertypefilter;
		}
		
	/**
	 * @param String $_hasusertypefilter
	 */
	public function setHasUserTypeFilter($_hasusertypefilter) {
		$this->_hasusertypefilter = $_hasusertypefilter;
	}
	/**
...
/**
	...
	function setDateFilterColumns($newdatefiltercolumns) {
		$this->_datefiltercolumns = $newdatefiltercolumns; 
	}
...
/**
	...
	function getAlphabetString(){
		...
		foreach ($alphabet as $letter) {
			...
			$alphabet_link_array[] = '<a href="javascript: void(0);" title="Browse directory beginning with '.$letter.'" id="'.$letter.'" class="alphabet">'.$letter.'</a>';
		} 
